...
func TestSmartLinkProcessor_RunJob_fetchesTitle(t *testing.T) {
	...
	if err := p.RunJob(context.Background(), "uuid-1", block, Services{LinkPreview: NewLinkPreviewService()}); err != nil {
...
func TestSmartLinkProcessor_RunJob_emptyHref(t *testing.T) {
	...
	if err := p.RunJob(context.Background(), "uuid-1", block, Services{}); err != nil {
