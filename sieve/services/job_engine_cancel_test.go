...
func TestCancel_QueuedJobNeverRunsAndLeavesTracker(t *testing.T) {
	...
	e.Submit(JobDescriptor{Category: "t", Meta: domain.JobInfo{JobID: "j1", Label: "hold"},
		Work: func() (any, error) { <-gate; return nil, nil }})
	ran := false
	e.Submit(JobDescriptor{Category: "t", Meta: domain.JobInfo{JobID: "j2", Label: "victim"},
		Work:       func() (any, error) { ran = true; return nil, nil },
		OnFinished: func(any) { ran = true }})
	e.Cancel("j2")
	close(gate)
	done := make(chan struct{})
	e.Submit(JobDescriptor{Category: "t", Meta: domain.JobInfo{JobID: "j3", Label: "sentinel"},
...
func TestCancel_ActiveJobCallbacksSuppressed(t *testing.T) {
	...
	e.Submit(JobDescriptor{Category: "t", Meta: domain.JobInfo{JobID: "j1", Label: "x"},
		Work:       func() (any, error) { close(started); <-release; return "r", nil },
		OnFinished: func(any) { fired = true }})
	<-started
	e.Cancel("j1")
	close(release)
	e.Submit(JobDescriptor{Category: "t", Meta: domain.JobInfo{JobID: "j2", Label: "sentinel"},
