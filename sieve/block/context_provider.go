...
// lets a caller exclude kinds from the document-truth slot — TARGET assembly passes
// a closure dropping the ai-block kind so prior answers never leak into TARGET.
