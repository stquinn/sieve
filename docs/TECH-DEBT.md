...
**Resolved by** the bite-sized plan [`docs/design/superpowers/plans/2026-06-19-shadowdoc-uniform-block-refactor.md`](superpowers/plans/2026-06-19-shadowdoc-uniform-block-refactor.md) (one commit per step, app runnable + green throughout — no big-bang):
