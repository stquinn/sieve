...
**Resolved by** the bite-sized plan [`docs/design/archive/superpowers/plans/2026-06-19-shadowdoc-uniform-block-refactor.md`](archive/superpowers/plans/2026-06-19-shadowdoc-uniform-block-refactor.md) (one commit per step, app runnable + green throughout — no big-bang):
