;(function() {
  ...
  window.SieveIcons = {
    ...
    // The tick a menu marks its CURRENT choice with, where every sibling in the
    // list is an equal alternative.
    ...
    // A tick over a wavy underline — the squiggle the button governs, drawn at
    // the one size that survives a 2px stroke.
    spellcheck:           svg('<polyline points="3 12 6 15 12 6"/><path d="M14 19c.8-1.4 2.2-1.4 3 0s2.2 1.4 3 0"/><path d="M2 19c.8-1.4 2.2-1.4 3 0s2.2 1.4 3 0"/><path d="M8 19c.8-1.4 2.2-1.4 3 0s2.2 1.4 3 0"/>')
  };
})();
