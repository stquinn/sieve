...
//   • this file (lens/surfaces/tiptap-vendor.js) — PM/editor reads only, for
...
//   • renderers/vendor-libs.js — bundled NON-PM libs only (MarkdownIt,
//     markdownItMark, createLowlight, common). The PM-free renderer package
//     reads THROUGH THAT seam and never imports this one.
// No file reads `globalThis.TipTap` directly; nothing outside renderers/
