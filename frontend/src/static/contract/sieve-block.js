// @ts-check
// sieve-block.js — the typed block (Block Renderer Contract,
// docs/design/archive/specs/2026-07-21-block-renderer-contract.md §typed block).
//
...
// one block. Blocks are authored by the service layer / the lens seam —
...
export class SieveBlock {
  ...
  /**
   * PM-FALLBACK constructor (resurrected nodes only — block-first flow is
