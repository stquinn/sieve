...
// single-read split (its PM twin is lens/surfaces/tiptap-vendor.js). Only
// renderers/ reads through here, and only for bundled libraries — never
...
// renderers/. Both seams read the SAME `window.TipTap` object; the
