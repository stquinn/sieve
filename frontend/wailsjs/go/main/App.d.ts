...
export function EvaluateBuffer(arg1:string):Promise<sieve.FilingRecommendation>;
...
export function GetNotes():Promise<Array<sieve.NoteEntry>>;

export function GetPrompts():Promise<Array<sieve.PromptEntry>>;

export function GetSession():Promise<sieve.Session>;
...
export function LoadSettings():Promise<sieve.Settings>;
...
export function SaveSession(arg1:sieve.Session):Promise<void>;

export function SaveSettings(arg1:sieve.Settings):Promise<void>;

export function SaveSidebarWidth(arg1:number):Promise<void>;

export function SearchStore(arg1:string):Promise<Array<sieve.SearchResult>>;
