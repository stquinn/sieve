...
Sieve is licensed under the [Apache License 2.0](LICENSE). Copyright 2026 Stephen Quinn.

Sieve bundles third-party open-source components; the full inventory with
license texts is in [`third-party-licenses.json`](third-party-licenses.json)
(generated by `tools/gencredits`) and is viewable in-app under
